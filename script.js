document.addEventListener("DOMContentLoaded", () => {
  ...
  const games = [
    ...
    { name: "ドラゴンクエスト スライムもりもりドラゴンクエスト2 大戦車としっぽ団", img: "icons/dqslime2.png", bg:"icons/dqslime2_bg.png", g: 85, m: 85, s: 85, text: "DSゲーム。スライムを操作して、敵を倒していくアクションゲーム。あまりやり込んでいないが、スライムが可愛くて癒される。ドラクエの世界観が好きな人にはおすすめ。" },
    { mame: "ドラゴンクエスト タクト", img: "icons/dqtact.png", bg:"icons/dqtact_bg.png", g: 84, m: 84, s: 86, text: "スマホゲーム。タクティクス系のゲームで、戦略を練りながらモンスターを動かしていく。あまりやり込んでいないが、ドラクエの世界観が好きな人にはおすすめ。" },
    { mame: "ドラゴンクエスト ウォーク", img: "icons/dqwalk.png", bg:"icons/dqwalk_bg.png", g: 85, m: 83, s: 88, text: "スマホゲーム。ポケモンGOのドラクエ版。歩きながらモンスターを倒していく。あまりやり込んでいないが、ドラクエの世界観が好きな人にはおすすめ。" },
