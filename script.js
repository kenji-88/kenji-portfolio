document.addEventListener("DOMContentLoaded", () => {
  ...
  const games = [
    ...
    { name: "ドラゴンクエストⅪ", img: "icons/dq11.png", g: 97, m: 97, s: 98, text: "グラフィック、曲、ストーリーともに最高だった作品。過去作からの伏線や曲のアレンジが盛り込まれており、涙なしではプレイできない。単純にプレイ難易度やストーリーがわかりやすく、ドラクエ初心者にもおすすめの作品。ぜひ一度はプレイしてみてほしい。" },
